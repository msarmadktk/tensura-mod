...
export default function Mezul() {
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <Navigation />
      <main className="container-main py-16 max-w-xl mx-auto">
        <h1 className="text-4xl font-bold mb-4 text-yellow-600">Mezul (Floor 50)</h1>
        <div className="flex justify-center mb-4"><img src="/mezul/b1.png" alt="Block" className="h-[400px] w-auto" /></div>
        ...
        <ul className="mb-4 text-base list-disc list-inside pl-2">
          ...
          <li><span className="font-bold">Strike</span> – Hits downward onto the enemy</li>
          <li><span className="font-bold">Backspin Strike</span> – Does a spin attack with his halberd</li>
          <li><span className="font-bold">Horse Kick</span> – Kicks backwards dealing knock back damage</li>
          <li><span className="font-bold">Ultra Spear</span> – Strikes many times in quick succession dealing major damage</li>
          <li><span className="font-bold">Whirlwind Strike</span> – Mezul spins towards the opponent weapon first dealing massive damage</li>
        </ul>

        <h2 className="text-lg font-bold text-sky-500 mb-2">Skills</h2>
        <div className="mb-4 text-base">
          ...
          <span className="font-bold">Extra Skills:</span> Ultra speed Regen, Magic Jamming
        </div>


        <h3 className="text-lg font-bold text-sky-500 mb-2 mt-6">Block</h3>
        <div className="flex justify-center mb-4"><img src="/mezul/b2.png" alt="Block" className="h-24 w-auto" /></div>
        <h3 className="text-lg font-bold text-sky-500 mb-2">Strike</h3>
        <div className="flex justify-center mb-4"><img src="/mezul/b3.png" alt="Strike" className="h-24 w-auto" /></div>
        <h3 className="text-lg font-bold text-sky-500 mb-2">Backspin Strike</h3>
        <div className="flex justify-center mb-4"><img src="/mezul/b4.png" alt="Backspin Strike" className="h-24 w-auto" /></div>
        <h3 className="text-lg font-bold text-sky-500 mb-2">Horse Kick</h3>
        <div className="flex justify-center mb-4"><img src="/mezul/b5.png" alt="Horse Kick" className="h-24 w-auto" /></div>
        <h3 className="text-lg font-bold text-sky-500 mb-2">Ultra Spear</h3>
        <div className="flex justify-center mb-4"><img src="/mezul/b6.png" alt="Ultra Spear" className="h-24 w-auto" /></div>
        <h3 className="text-lg font-bold text-sky-500 mb-2">Whirlwind Strike</h3>
        <div className="flex justify-center mb-4"><img src="/mezul/b7.png" alt="Whirlwind Strike" className="h-24 w-auto" /></div>
