...
export default function SpiderDagger() {
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <Navigation />
      <main className="container-main py-16 flex flex-col items-center">
        <h1 className="text-5xl font-bold mb-4 text-yellow-600">Spider Dagger</h1>
        <div className="w-full max-w-xl">
          <div className="flex justify-center mb-6">
            <img src="/spiderdagger/s1.png" alt="Spider Dagger" className="w-64 h-64 object-contain" />
          </div>
          ...
          <div className="mb-4 text-base">
            <span className="font-bold">Fatal Poison buildup with repeated strikes.</span> Poison stacks and refreshes with continued attacks
          </div>
          <div className="rounded-2xl overflow-hidden shadow-lg border border-border mb-8">
            <img src="/spiderdagger/s2.png" alt="Spider Dagger In-game" className="w-full h-auto object-cover" />
          </div>
          <h2 className="text-2xl font-bold text-sky-500 mb-2">Where to Find</h2>
          <div className="mb-4 text-base">
            <a
              href="/wiki/floor-10-black-spider-boss"
